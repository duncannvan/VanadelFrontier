...
public partial class ToolData : Resource
{
    ...
    [Export]
    public Texture2D ToolTexture { get; private set; } = null;

    [Export]
    public virtual float ToolCooldownSec { get; protected set; } = 0.0f;
    ...
    private void IncrementAnimationLibrariesIdx()
    {
        ...
        AnimationLibrariesIdx = (byte)((AnimationLibrariesIdx + 1) % AnimationLibraries.Length);
    }
}