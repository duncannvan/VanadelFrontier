...
public partial class Player : CharacterBody2D, IHittable
{
    ...
    private void SelectTool(byte toolIndex)
    {
        _toolManager.Call("select_tool", toolIndex);
    }
    ...
    private void HandleMovement()
    {
        ...
        {
            if (_toolManager.Call("is_tool_selected").As<bool>())
            {
                _toolManager.Call("use_tool", this);
            }
        }
    }
